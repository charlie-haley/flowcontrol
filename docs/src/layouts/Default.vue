...
:root {
  ...
  --color-text-primary: #fffbf5;
  --color-ui-sidebar: #fcf4e7;
  --color-ui-border: #fffbf5;
  --color-ui-primary: #925C4E;
}

html[lights-out] {
  --color-ui-background: #333333;
  --color-ui-typo: theme('colors.white');
  --color-text-primary: #494949;
  --color-ui-sidebar: #494949;
  --color-ui-border: #333333;
  --color-ui-primary: #F7EAD4;
}
