    ...
    <div class="container">
      ...
      <div class="flex items-center justify-between -mx-2 sm:-mx-4">
        <div class="flex flex-col items-center px-2 mr-auto sm:px-4 sm:flex-row">
          ...
          <div v-if="settings.nav.links.length > 0" class="hidden ml-2 mr-3 sm:flex sm:ml-4">
            <g-link
              key="/"
              to="/"
              exact-active-class="nav-link-active"
              class="inline-block p-5 font-medium nav-link text-ui-typo hover:text-ui-primary"
            >
              Home
            </g-link>
            <g-link
